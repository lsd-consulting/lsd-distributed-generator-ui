...
dependencies {
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:7.0.40")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.8.0")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.8.0")
    ...
    postgresComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-postgres-connector:4.0.43")
