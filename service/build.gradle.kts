...
dependencies {
    ...
    kapt("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.37") {
        because("we want to generate WireMock stubs for client")
    }
    compileOnly("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.37")
    ...
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.3.0")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.3.0")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:24.13.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:24.13.0")
