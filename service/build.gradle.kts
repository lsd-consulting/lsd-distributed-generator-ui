...
dependencies {
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:10.0.0")
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:7.0.2")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.6.1")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.6.1")
    ...
    postgresComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-postgres-connector:3.2.12")
