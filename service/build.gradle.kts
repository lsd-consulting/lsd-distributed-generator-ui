...
dependencies {
    ...
    mongoComponentTestImplementation("de.flapdoodle.embed:de.flapdoodle.embed.mongo:4.9.2") {
        because("we want to run tests against a database")
    }
    mongoComponentTestImplementation("com.approvaltests:approvaltests:22.1.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:22.1.0")
