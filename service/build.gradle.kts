...
dependencies {
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.0.2")
    ...
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.19.4")
    postgresComponentTestImplementation("org.testcontainers:junit-jupiter:1.19.4")
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.19.4")
