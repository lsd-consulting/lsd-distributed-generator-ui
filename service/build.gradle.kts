...
dependencies {
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.1.6")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:24.1.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:24.1.0")
