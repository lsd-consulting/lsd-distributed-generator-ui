...
dependencies {
    ...
    kapt("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.34") {
        because("we want to generate WireMock stubs for client")
    }
    compileOnly("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.34")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.2.28")
    ...
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.2.1")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.2.1")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:24.12.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:24.12.0")
