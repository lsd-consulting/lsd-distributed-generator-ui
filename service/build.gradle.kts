...
dependencies {
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:7.2.14")
    ...
    mongoComponentTestImplementation("de.flapdoodle.embed:de.flapdoodle.embed.mongo:4.10.1") {
    ...
    postgresComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-postgres-connector:1.0.10")
    ...
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.19.2")
    postgresComponentTestImplementation("org.testcontainers:junit-jupiter:1.19.2")
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.19.2")
