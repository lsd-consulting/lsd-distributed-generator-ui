...
dependencies {
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.1.4")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:24.0.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:24.0.0")
