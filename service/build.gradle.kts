...
dependencies {
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:25.0.23")
    ...
    postgresComponentTestImplementation("com.zaxxer:HikariCP:6.3.2")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:25.0.23")
