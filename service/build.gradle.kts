...
dependencies {
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.0.17")
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:6.0.3")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:23.0.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:23.0.0")
