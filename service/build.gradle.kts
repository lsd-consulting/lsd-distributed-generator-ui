...
dependencies {
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:7.0.45")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.9.1")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.9.1")
