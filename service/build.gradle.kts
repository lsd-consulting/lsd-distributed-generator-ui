...
dependencies {
    ...
    compileOnly("org.wiremock:wiremock-standalone:3.7.0")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.1.12")
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:6.0.16")
    ...
    mongoComponentTestImplementation("de.flapdoodle.embed:de.flapdoodle.embed.mongo:4.14.0") {
