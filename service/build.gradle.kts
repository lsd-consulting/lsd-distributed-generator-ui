...
dependencies {
    ...
    kapt("io.github.lsd-consulting:spring-wiremock-stub-generator:3.1.10") {
        because("we want to generate WireMock stubs for client")
    }
    compileOnly("io.github.lsd-consulting:spring-wiremock-stub-generator:3.1.10")
    compileOnly("org.wiremock:wiremock-standalone:3.12.0")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.2.33")
    ...
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.3.1")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.3.1")
    ...
    mongoComponentTestImplementation("org.testcontainers:junit-jupiter:1.20.5")
    mongoComponentTestImplementation("org.testcontainers:mongodb:1.20.5") {
    ...
    postgresComponentTestImplementation("com.zaxxer:HikariCP:6.2.1")
    ...
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.20.5")
    postgresComponentTestImplementation("org.testcontainers:junit-jupiter:1.20.5")
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.20.5")
