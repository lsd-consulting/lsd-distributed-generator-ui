...
dependencies {
    ...
    kapt("io.github.lsd-consulting:spring-wiremock-stub-generator:2.3.0") {
        because("we want to generate WireMock stubs for client")
    }
    compileOnly("io.github.lsd-consulting:spring-wiremock-stub-generator:2.3.0")
    compileOnly("org.wiremock:wiremock-standalone:3.4.2")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.0.11")
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:6.0.2")
    ...
    mongoComponentTestImplementation("de.flapdoodle.embed:de.flapdoodle.embed.mongo:4.12.2") {
        because("we want to run tests against a database")
    }
    mongoComponentTestImplementation("com.approvaltests:approvaltests:22.4.0")
    ...
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.19.6")
    postgresComponentTestImplementation("org.testcontainers:junit-jupiter:1.19.6")
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.19.6")

    postgresComponentTestImplementation("com.approvaltests:approvaltests:22.4.0")
