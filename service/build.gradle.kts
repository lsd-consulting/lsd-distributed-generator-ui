...
dependencies {
    ...
    compileOnly("org.wiremock:wiremock-standalone:3.9.0")
    ...
    mongoComponentTestImplementation("de.flapdoodle.embed:de.flapdoodle.embed.mongo:4.16.1") {
    ...
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.20.0")
    postgresComponentTestImplementation("org.testcontainers:junit-jupiter:1.20.0")
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.20.0")
