...
dependencies {
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:7.0.19")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.6.3")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.6.3")
