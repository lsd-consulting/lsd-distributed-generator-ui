...
dependencies {
    ...
    kapt("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.13") {
        because("we want to generate WireMock stubs for client")
    }
    compileOnly("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.13")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.2.5")
