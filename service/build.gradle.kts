...
dependencies {
    ...
    kapt("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.17") {
        because("we want to generate WireMock stubs for client")
    }
    compileOnly("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.17")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.2.9")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:24.7.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:24.7.0")
