...
dependencies {
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:11.0.52")
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:7.0.20")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.6.4")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.6.4")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:25.10.0")
    ...
    postgresComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-postgres-connector:4.0.18")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:25.10.0")
