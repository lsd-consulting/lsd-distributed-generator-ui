...
dependencies {
    ...
    kapt("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.15") {
        because("we want to generate WireMock stubs for client")
    }
    compileOnly("io.github.lsd-consulting:spring-wiremock-stub-generator:3.0.15")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.2.6")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:24.6.0")
    ...
    postgresComponentTestImplementation("com.zaxxer:HikariCP:6.0.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:24.6.0")
