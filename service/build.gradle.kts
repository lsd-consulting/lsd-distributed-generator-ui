...
dependencies {
    ...
    compileOnly("org.wiremock:wiremock-standalone:3.5.3")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.0.29")
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:6.0.9")
    ...
    postgresComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-postgres-connector:3.0.1")
