...
dependencies {
    ...
    kapt("io.github.lsd-consulting:spring-wiremock-stub-generator:3.1.6") {
        because("we want to generate WireMock stubs for client")
    }
    compileOnly("io.github.lsd-consulting:spring-wiremock-stub-generator:3.1.6")
    ...
    mongoComponentTestImplementation("com.approvaltests:approvaltests:24.16.0")
    ...
    postgresComponentTestImplementation("com.approvaltests:approvaltests:24.16.0")
