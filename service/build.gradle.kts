...
dependencies {
    ...
    compileOnly("org.wiremock:wiremock-standalone:3.13.0")
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.2.41")
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:6.1.11")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-core:5.5.0")
    mongoComponentTestImplementation("org.mongodb:mongodb-driver-sync:5.5.0")
    ...
    mongoComponentTestImplementation("org.testcontainers:junit-jupiter:1.21.0")
    mongoComponentTestImplementation("org.testcontainers:mongodb:1.21.0") {
        because("we want to test against a real MongoDb in Docker")
    }
    mongoComponentTestImplementation("com.approvaltests:approvaltests:24.21.1")
    ...
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.21.0")
    postgresComponentTestImplementation("org.testcontainers:junit-jupiter:1.21.0")
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.21.0")

    postgresComponentTestImplementation("com.approvaltests:approvaltests:24.21.1")
