...
dependencies {
    ...
    // LSD
    implementation("io.github.lsd-consulting:lsd-distributed-generator:8.0.6")
    ...
    mongoComponentTestImplementation("io.github.lsd-consulting:lsd-distributed-mongodb-connector:6.0.1")
    ...
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.19.5")
    postgresComponentTestImplementation("org.testcontainers:junit-jupiter:1.19.5")
    postgresComponentTestImplementation("org.testcontainers:postgresql:1.19.5")
